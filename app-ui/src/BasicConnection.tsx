...
import createEngine, { DiagramModel, DefaultNodeModel, DefaultLinkModel, DefaultLinkFactory, DefaultPortModel, PointModel, DefaultLinkWidget, LinkWidget } from '@projectstorm/react-diagrams';
...
const Connection = () => {
	...
	node1.registerListener({
		positionChanged : () =>{console.log("Position of Node 1 changed")}
	})
	...
	node2.registerListener({
		positionChanged : () =>{console.log("Position of Node 2 changed")}
	})
